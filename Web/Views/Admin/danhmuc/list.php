...
include_once(__DIR__ . '/../../../Models/M_danhMuc.php');
?>
<main id="main" class="main">
  <div class="container mt-4" >
    ...
    <!-- Nút Thêm Danh Mục -->
    <a href="http://localhost/duAn1_HDPlus/index.php?act=adddm" class="btn btn-success mb-3">Thêm Danh Mục</a>
    ...
    <table class="table table-bordered " >
      ...
      <tbody>
        ...
        extract($danhmuc);
        $updatedm = "http://localhost/duAn1_HDPlus/index.php?act=updatedm&id=".$id_danhmuc;
        $deletedm = "http://localhost/duAn1_HDPlus/index.php?act=deletedm&id=".$id_danhmuc;
