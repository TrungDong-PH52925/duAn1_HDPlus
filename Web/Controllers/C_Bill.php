        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['bill'])) {
            ...
            if (is_array($products)) {
                foreach ($products as $product) {
                    ...
                    $this->b->insertBill($status_payment, $trangthai_bill, $id_user, $user_name, $user_address, $user_phone, $user_email, $id_cart, $id_sanpham, $ten_sanpham, $img_sanpham, $gia_hientai,$soluong, $total);
