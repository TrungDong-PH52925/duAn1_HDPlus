...
class Bill {
    ...
    public function insertBill($status_payment, $trangthai_bill, $id_user, $user_name, $user_address, $user_phone, $user_email, $id_cart, $id_sanpham, $ten_sanpham, $img_sanpham,$mota_sanpham, $gia_hientai, $soluong, $total) {
        ...
        $sql = "INSERT INTO bill (status_payment, trangthai_bill, id_user, user_name, user_address, user_phone, user_email, id_cart, id_sanpham, ten_sanpham, img_sanpham,mota_sanpham, gia_hientai, soluong, total) 
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
